             ...
             <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">List Laporan Accounting/Pajak</h4>
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ url('/') }}">Home</a></li>
                                    <li class="breadcrumb-item"><a href="{{ url('/DashboardLaporan') }}">Bagian TJ</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Accounting/Pajak</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                                        ...
                                                        <td>
                                                            <ul class="list-style-none">
                                                                <li class="d-flex no-block card-body">
                                                                    ...
                                                                    <div>
                                                                        <a href="{{$ACC_PJK->link}}" target="_blank" class="m-b-0 font-medium p-0">{{$ACC_PJK->judul}}</a>
                                                                        <span class="text-muted">{{$ACC_PJK->desc}}</span>
                                                                    </div>
                                                                    <div class="ml-auto">
                                                                        <div class="tetx-right">
                                                                            <h5 class="text-muted m-b-0">{{ date('d', strtotime($ACC_PJK->created_at)) }}</h5>
                                                                            <span class="text-muted font-16">{{ date('F', strtotime($ACC_PJK->created_at)) }}</span>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                            </ul>
