             ...
             <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">List Laporan Pendidikan/Pemateri</h4>
                                                        ...
                                                        <td>
                                                            <ul class="list-style-none">
                                                                <li class="d-flex no-block card-body">
                                                                    ...
                                                                    <div>
                                                                        <a href="{{$PD->link}}" target="_blank" class="m-b-0 font-medium p-0">{{$PD->judul}}</a>
                                                                        <span class="text-muted">{{$PD->desc}}</span>
                                                                    </div>
                                                                    <div class="ml-auto">
                                                                        <div class="tetx-right">
                                                                            <h5 class="text-muted m-b-0">{{ date('d', strtotime($PD->created_at)) }}</h5>
                                                                            <span class="text-muted font-16">{{ date('F', strtotime($PD->created_at)) }}</span>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                            </ul>
