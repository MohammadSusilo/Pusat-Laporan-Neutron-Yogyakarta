             ...
             <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">List Laporan Data</h4>
                                                        ...
                                                        <td>
                                                            <ul class="list-style-none">
                                                                <li class="d-flex no-block card-body">
                                                                    ...
                                                                    <div>
                                                                        <a href="{{$DT->link}}" target="_blank" class="m-b-0 font-medium p-0">{{$DT->judul}}</a>
                                                                        <span class="text-muted">{{$DT->desc}}</span>
                                                                    </div>
                                                                    <div class="ml-auto">
                                                                        <div class="tetx-right">
                                                                            <h5 class="text-muted m-b-0">{{ date('d', strtotime($DT->created_at)) }}</h5>
                                                                            <span class="text-muted font-16">{{ date('F', strtotime($DT->created_at)) }}</span>
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                            </ul>
