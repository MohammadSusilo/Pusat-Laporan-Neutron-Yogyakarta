...
<body class="login-page">
    <div class="login-box">
        ...
        <div class="card">
            <div class="body">
                <!-- Card Notifikasi -->
                    @if(\Session::has('token-kosong'))
                        <div class="alert bg-pink alert-dismissible" role="alert">
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                            <div>{{Session::get('token-kosong')}}</div>
                        </div>
                    @endif
                    @if(\Session::has('token-salah'))
                        <div class="alert bg-pink alert-dismissible" role="alert">
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                            <div>{{Session::get('token-salah')}}</div>
                        </div>
                    @endif
                <!-- Card Notifikasi -->
                <form method="POST" action="{{ url('token/cek') }}">
                @csrf
                    <div class="input-group">
                        ...
                        <div class="form-line">
                            <input id="token" placeholder="TOKEN" type="text" class="form-control" name="token" autocomplete="off" required autofocus>
                        </div>
                    </div>
                    <div class="row">
